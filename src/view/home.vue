<template>
  <div class="gulu-homePage">
    <nav class="gulu-homeNav">
      <div class="logo">
      ...
      <ol class="doc">
        <li><a href="mailto:907090585@qq.com">联系我</a> </li>
    ...
    <main class="gulu-homeContent">
      ...
      <div class="link">
        ...
        <router-link to="/doc"><button>开始使用</button></router-link>
      </div>
    </main>
